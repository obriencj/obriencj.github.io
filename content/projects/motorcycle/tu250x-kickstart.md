...
[![Original TU250X drive shaft (top), ST250XK4 (middle), SP250 (bottom)][DSC00104]{.image-process-inline .right}][DSC00104]
...
[DSC00104]: {static}/photos/DSC00104.JPG


## Getting Kickstart Parts

[![Parts waiting to be installed][IMG2816]{.image-process-inline .right}][IMG2816]
...
[IMG2816]: {static}/photos/IMG_2816.JPG
...
[![My workspace before the work][IMG2831]{.image-process-inline .right}][IMG2831]
...
[IMG2831]: {static}/photos/IMG_2831.JPG
...
[![Manuel, relay instructions][DSC00115]{.image-process-inline .right}][DSC00115]
...
[DSC00115]: {static}/photos/DSC00115.JPG
...
[![I never did get into yoga][IMG2838]{.image-process-inline .right}][IMG2838]
...
[IMG2838]: {static}/photos/IMG_2838.JPG
...
[![Eventually you'll get to see all this][DSC00090]{.image-process-inline .right}][DSC00090]
...
[DSC00090]: {static}/photos/DSC00090.JPG
...
[![Return spring, guide, and circlip][DSC00098]{.image-process-inline .right}][DSC00098]
...
[DSC00098]: {static}/photos/DSC00098.JPG

[![Temporarily attached kickstart lever for testing of action][DSC00096]{.image-process-inline .right}][DSC00096]
...
[DSC00096]: {static}/photos/DSC00096.JPG
...
[![Sliding gear, guide, and stopper][DSC00099]{.image-process-inline .right}][DSC00099]
...
[DSC00099]: {static}/photos/DSC00099.JPG
...
[![The kickstart gearing and the idler][DSC00107]{.image-process-inline .right}][DSC00107]
...
[DSC00107]: {static}/photos/DSC00107.JPG
...
[![Just the covers and I'm all set][DSC00109]{.image-process-inline .right}][DSC00109]
...
[DSC00109]: {static}/photos/DSC00109.JPG
...
[PAIR removal]: {filename}/projects/motorcycle/tu250x-pair-removal.md
...
[![Looks like it belongs there][DSC00134]{.image-process-inline .right}][DSC00134]
...
[DSC00134]: {static}/photos/DSC00134.JPG
...
- 2023-09-24: Update to local photos since picasa is dead and gone
